...
ActiveRecord::Schema[7.0].define(version: 2023_09_23_160213) do
  ...
  create_table "outings", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["contestant_id"], name: "index_outings_on_contestant_id"
  end

  add_foreign_key "contestants", "bachelorettes"
  add_foreign_key "outings", "contestants"
end
